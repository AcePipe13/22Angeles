...
# ---------------------------------------------------
# --- Aquí realizas y guardas todo lo que quieras ---
# ---------------------------------------------------
...
git commit -m "Cambie este codigo que hace esto - Tu Apellido"
...
Una vez que el admin haya aprobado y unido (Merged) las tareas en GitHub, sigue esta rutina para limpiar tu computadora y empezar el siguiente ejercicio:
